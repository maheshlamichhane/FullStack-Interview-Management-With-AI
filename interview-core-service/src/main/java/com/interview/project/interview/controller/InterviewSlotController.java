...
import com.interview.project.interview.dto.AccountsMsgDto;
...
import com.interview.project.interview.service.InterviewSlotService;
...
public class InterviewSlotController {
    ...
    @GetMapping("/sayHelo")
    public Mono<String> sayHelo() {
        return Mono.just("Hello World!");
    }

    @PostMapping("/interviews/interview-slots")
