...
public class FeedbackController {
    ...
    public ResponseEntity<FeedbackResponse> getFinalFeedback(@PathVariable Long interviewId) {
        FeedbackResponse response = feedbackService.getFinalFeedbackByInterview(interviewId);
